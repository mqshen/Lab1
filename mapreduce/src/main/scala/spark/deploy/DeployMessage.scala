...
import spark.rpc.{RpcAddress, RpcEndpointRef}
import spark.util.Utils
import spark.rpc.RpcEndpointRef
...
private[deploy] object DeployMessages {
  ...
  case class LaunchDriver(driverId: String) extends DeployMessage
  ...
  case class RegisterApplication(driver: RpcEndpointRef)
    extends DeployMessage
  ...
  case class RequestSubmitDriver() extends DeployMessage
  ...
  case class WorkerStateResponse(host: String, port: Int, workerId: String, masterUrl: String,
