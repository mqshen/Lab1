...
import spark.network.client.TransportClient;
import spark.network.client.TransportClientBootstrap;
import spark.network.client.TransportClientFactory;
import spark.network.client.TransportResponseHandler;
import spark.network.protocol.MessageDecoder;
import spark.network.protocol.MessageEncoder;
import spark.network.server.*;
import spark.network.util.IOMode;
import spark.network.util.NettyUtils;
import spark.network.util.TransportConf;
import spark.network.util.TransportFrameDecoder;
 ...
 * {@link spark.network.server.TransportChannelHandler}.
 *
...
public class TransportContext {
   ...
   * has a {@link spark.network.server.TransportChannelHandler} to handle request or
   * response messages.
   *
