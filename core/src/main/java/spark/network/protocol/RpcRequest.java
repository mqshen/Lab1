...
import spark.network.buffer.NettyManagedBuffer;

/**
 * A generic RPC which is handled by a remote {@link spark.network.server.RpcHandler}.
 * This will correspond to a single
 * {@link spark.network.protocol.ResponseMessage} (either success or failure).
 */
