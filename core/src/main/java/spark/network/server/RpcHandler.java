...
/**
 * Handler for sendRPC() messages sent by {@link spark.network.client.TransportClient}s.
 */
public abstract class RpcHandler {
   ...
   * ({@link spark.network.client.StreamCallback#onData(String, ByteBuffer)})
   * will fail the entire channel.  A failure in "post-processing" the stream in
   * {@link spark.network.client.StreamCallback#onComplete(String)} will result in an
