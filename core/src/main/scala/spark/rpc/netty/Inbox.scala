...
import spark.rpc.{RpcAddress, RpcEndpoint, ThreadSafeRpcEndpoint}
...
/** A message to tell all endpoints that a spark.network error has happened. */
          ...
          case RpcMessage(_sender, content, context) =>
            try {
              ...
              case NonFatal(e) =>
                ...
                // Throw the spark.exception -- this spark.exception will be caught by the safelyCall function.
