...
private[netty] class Dispatcher(nettyEnv: NettyRpcEnv, numUsableCores: Int) extends Logging {
   ...
   *
   * This can be used to make spark.network events known to all end points (e.g. "a new node connected").
   */
  ...
  private val threadpool: ThreadPoolExecutor = {
    ...
    val numThreads = nettyEnv.conf.getInt("spark.spark.rpc.netty.dispatcher.numThreads",
